...
var _bip39English = require("bip39-english");

var _bip39English2 = _interopRequireDefault(_bip39English);
...
var Mnemonic = function () {
  ...
  _createClass(Mnemonic, [{
    ...
    value: function generate() {
      ...
      return _bip39English2.default.generateMnemonic(bits, _randombytes2.default, wordlist);
    }
  }, {
    key: "fromEntropy",
    value: function fromEntropy(bytes, wordlist) {
      return _bip39English2.default.entropyToMnemonic(bytes, wordlist);
    }
  }, {
    key: "toEntropy",
    value: function toEntropy(mnemonic, wordlist) {
      return Buffer.from(_bip39English2.default.mnemonicToEntropy(mnemonic, wordlist), "hex");
    }
  }, {
    key: "validate",
    value: function validate(mnemonic, wordlist) {
      ...
      var isValid = _bip39English2.default.validateMnemonic(mnemonic, wordlist);
    ...
    value: function toSeed(mnemonic) {
      ...
      return _bip39English2.default.mnemonicToSeed(mnemonic, password);
    }
  }, {
    key: "wordLists",
    value: function wordLists() {
      return _bip39English2.default.wordlists;
    }
  }, {
    key: "toKeypairs",
    value: function toKeypairs(mnemonic) {
      ...
      var hdNode = _bitcoincashjsLib2.default.HDNode.fromSeedBuffer(rootSeedBuffer);
